...
CREATE TABLE proyectos (
  ...
  nombre TEXT NOT NULL,
  tipo_servicio TEXT NOT NULL DEFAULT 'cliente', -- cliente | interno | personal | otro
...
CREATE TABLE tareas (
  ...
  nombre TEXT NOT NULL,
  categoria TEXT NOT NULL DEFAULT 'otro', -- trabajo_profundo | reuniones | administracion | comunicacion | formacion | otro
